...
func TestMemoryEngine_GetNonExistent(t *testing.T) {
	engine := NewMemoryEngine()
...
func TestMemoryEngine_DeleteNonExistent(t *testing.T) {
	engine := NewMemoryEngine()
...
func TestMemoryEngine_Overwrite(t *testing.T) {
	engine := NewMemoryEngine()
...
func TestMemoryEngine_EmptyKeyAndValue(t *testing.T) {
	engine := NewMemoryEngine()
...
func TestMemoryEngine_MultipleOperations(t *testing.T) {
	engine := NewMemoryEngine()
